...
const Map: React.FC<MapProps> = ({ mapCenter }) => {
  ...
  fetch(
    'https://cors-anywhere.herokuapp.com/https://mbus.ltp.umich.edu/bustime/api/v3/getrtpidatafeeds?requestType=getrtpidatafeeds&locale=en&key=NztS3ptaAMhC2tsS3rUKFfqPW&format=json',
    {
      method: 'GET',
      redirect: 'follow',
      headers: {
